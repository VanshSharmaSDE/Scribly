  ...
  const getBannerContent = () => {
    if (localAIStatus.isLoading) {
      ...
      return {
        ...
        actionIcon: <RefreshCw className={`h-4 w-4 flex item-center ${isInitializing ? 'animate-spin' : ''}`} />,
        variant: 'info'
      };
    } else {
      return {
  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className={`relative border rounded-lg p-3 sm:p-4 mb-4 sm:mb-6 ${variants[bannerContent.variant]}`}
      >
        ...
        <div className="flex flex-col space-y-3 sm:hidden">
          ...
          <div className="pl-8">
            <Button
              ...
              variant="outline"
              size="sm"
              className="flex items-center space-x-2 text-sm px-3 py-2 w-full sm:w-auto justify-center"
            >
